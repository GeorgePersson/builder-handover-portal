...
import { Bot, FileUp, LoaderCircle } from "lucide-react";
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[0.85fr_1.15fr]">
        <div className="rounded-md border border-cyan-200 bg-white p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <button
              className="inline-flex h-10 items-center gap-2 rounded-md border border-cyan-300 bg-white px-4 text-sm font-semibold text-cyan-800 hover:bg-cyan-50"
              disabled={isLoading}
          ...
          <p className="mt-3 text-xs leading-5 text-cyan-800">
            Processing reads the PDF, saves the upload, and sends proposed items to review.
          </p>
        </div>
        ...
        <details className="rounded-md border border-cyan-200 bg-white p-4">
          <summary className="cursor-pointer text-sm font-semibold text-cyan-950">
            Test with pasted specification text
          </summary>
          <p className="mt-2 text-xs leading-5 text-cyan-800">
            Handy for quick demos or specs copied from an email before a real PDF is available.
          </p>
          <label className="text-sm font-medium text-cyan-950">Paste spec text</label>
          <textarea
