...
- Run `npm.cmd run smoke:supabase-config` on desktop after adding Supabase secrets to confirm required REST tables and the `handover-documents` bucket before the next credentialed app smoke.

## Last Updated

- 2026-06-20: Added a Supabase configuration smoke helper and desktop checklist notes for secret-gated Supabase/OpenAI/LlamaCloud/Cloudflare/Resend/Stripe validation.
